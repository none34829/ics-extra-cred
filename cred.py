...
class Background:
    ...
    def draw_clouds(self):
        self.t.penup()
        for position in [(200, 200), (-200, 250)]:
            self.t.goto(position)
            self.t.color("white")
            self.t.begin_fill()
            self.t.circle(30)
            self.t.end_fill()
            for offset in [(20, 20), (-20, 20)]:
                self.t.goto(position[0]+offset[0], position[1]+offset[1])
                self.t.begin_fill()
                self.t.circle(25)
                self.t.end_fill()
...
class Lightning:
    ...
    def draw_lightning(self):
        self.t.penup()
        self.t.goto(random.randint(-100, 100), random.randint(100, 200))
        self.t.pendown()
        self.t.seth(-90)
        self.t.fd(50)
        self.t.left(45)
...
def main():
    ...
    turtle.setup(width=1300, height=800)
    ...
    bg.draw_clouds()
    lightning = Lightning()
    turtle.ontimer(lightning.flash, 1000)
    pikachu = Pikachu()
    pikachu.start()
    turtle.mainloop()
